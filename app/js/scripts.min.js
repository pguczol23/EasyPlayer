...
$(function() {
    ...
    var files = Directory.GetAllFilesAsync('F:\\Music', ['.mp3', '.ogg', '.wav'], false,false);
    var files2 = Directory.GetAllFilesAsync('F:\\Music', ['.mp3', '.ogg', '.wav'], true,true);
    ...
    files2.then(val => {
        val.forEach((v,k) => {
            ...
            $('.audio-list').append('' +
                ...
                '<div class="audio-created">' + File.GetCreatedTime(v).toLocaleString().replace(',','') +'</div>' +
                '<div class="audio-modified">' + File.GetModifiedTime(v).toLocaleString().replace(',','') +'</div>' +
                '<div class="audio-actions">' +
                '<button class="btn" data-action="play-audio" data-audio-path="' + v + '"><i class="fas fa-play"></i></button>' +
                '</div>' +
                '</div>');
        });
